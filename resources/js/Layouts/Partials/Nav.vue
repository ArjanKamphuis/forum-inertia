    ...
    <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div v-if="signedIn" class="hidden sm:flex sm:items-center sm:ml-6">
                    <!-- Settings Dropdown -->
        ...
        <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                <ResponsiveNavLink :href="route('threads')" :active="route().current('threads')">
                    All Threads
                </ResponsiveNavLink>
            </div>

            <!-- Responsive Settings Options -->
            <div v-if="signedIn" class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                <div class="px-4">
