...
const classes = computed(() =>
    props.active
        ? 'block w-full px-4 py-2 text-left text-sm leading-5 text-white bg-gray-700 dark:text-gray-700 dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-100 focus:outline-none focus:bg-gray-800 dark:focus:bg-gray-100 transition duration-150 ease-in-out'
